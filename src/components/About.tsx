...
function About() {
   return (
      <section id="about" data-section className={sectionClasses}>
         ...
         <div className="text-dark text-opacity-70 text-center rounded-md shadow bg-dark bg-opacity-5 backdrop-blur-sm dark:bg-white dark:bg-opacity-5 h-auto z-10">
